...
- asegurate de inicializar bien los perifericos, como el i2c y los pines análogos. la temperatura se mide con el sensor de temperatura interno del stm32. 
...
|PIN| Descripción|Función|
|---|------------|-------|
|LNA_ON| pin shutdown del qpl9547tr7| enciende/apaga el LNA mas cercano al receptor|
...
|SEL_LNA1| v2 del chip as179-92lf| conecta la salida del selector del LNA a uno de los transmisores o receptores|
|SEL_LNA2| v1 del chip as179-92lf| conecta la salida del selector del LNA a uno de los transmisores o receptores|
